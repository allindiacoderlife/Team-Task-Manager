...
-- CreateEnum
CREATE TYPE "OTPType" AS ENUM ('LOGIN', 'RESET_PASSWORD');
...
-- AddForeignKey
ALTER TABLE "_OTPToUser" ADD CONSTRAINT "_OTPToUser_A_fkey" FOREIGN KEY ("A") REFERENCES "otps"("id") ON DELETE CASCADE ON UPDATE CASCADE;
